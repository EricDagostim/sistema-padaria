<?php
    ...
    if(isset($_POST['cadastro'])){
        ...
        $result = mysqli_query($conexao, "INSERT INTO material (nome, vl_unitario, ps_unitario, quantidade) VALUES ('$nome', '$vl_unitario', '$ps_unitario','$quantidade')");
        
        if ($result) {
            echo "Material cadastrado com sucesso!";
            // header("Location: {$urlBase}Materials/index.php");
        }else {
                ...
                <div class="col-6 offset-3">
                    ...
                    <form class="form-cadastro" method="POST" >
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" name="nome" class="form-control" placeholder="Nome Material *" aria-label="Nome" aria-describedby="basic-addon1" required>
                        </div>
